...
create policy "app_settings_select_public_keys" on public.app_settings for select to authenticated using (key in ('payment_card_number','payment_card_holder'));
...
insert into public.app_settings (key, value) values ('payment_card_number', '8600 1234 5678 9012');
insert into public.app_settings (key, value) values ('payment_card_holder', 'OSH PIZZA LLC');
